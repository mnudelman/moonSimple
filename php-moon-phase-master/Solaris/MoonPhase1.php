...
* License: MIT
* mnudelman: свои 5 копеек. из __construct() вытащим в отдельную private init()
*            все константы
 *           добавил setTs($ts)  - установку другого момента времени
*
*/
namespace Solaris;
...
//	    $this->timestamp = $ts ;
    ...
    public function getResult() {
	    $newmoon = $this->get_phase('new_moon') ;
        $nextNewmoon = $this->get_phase('next_new_moon') ;
        $fullmoon =  $this->get_phase('full_moon') ;
	    return [
	        'phase' => $this->phase,
